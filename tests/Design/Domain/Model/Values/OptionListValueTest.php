...
final class OptionListValueTest extends TestCase
{
    ...
    {
        $this->assertSame('list([Label 1])', OptionListValue::withElements(1)->toTypedString());
        $this->assertSame('list([Label 1;Label 2;Label 3])', OptionListValue::withElements(3)->toTypedString());
    }
